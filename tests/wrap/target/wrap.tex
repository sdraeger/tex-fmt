...
% split over three lines which is another edge case which should be checked here
% with all these extra words

% lines containing \<space>
This line would usually be split at the special character part with a slash\ but
it's best to break the line earlier.

% long lines with brackets
(This line is too long because it has more than eighty characters inside it.
  Therefore it should be split. It also needs splitting onto multiple lines, and
the middle lines should be indented due to these brackets.)
