...
\title{The latex-formatter CTAN package \\ v0.5.8}
...
\begin{table}[H]
  \begin{center}
    \begin{tabular}{|l|l|l|l|}
      ...
      \texttt{--wrap-strategy <STRATEGY>} &       & \texttt{balanced}
      & Strategy for selecting wrap points \\
...
The \texttt{balanced} wrap strategy uses line-break planning to fill non-final
lines while avoiding short intermediate lines. The \texttt{greedy} strategy
preserves the legacy \texttt{wrapmin}-based behavior.
...
\begin{table}[H]
  \begin{center}
    \begin{tabular}{|l|l|l|l|}
      ...
      & Target minimum length for greedy wrapping \\
      \texttt{wrap-strategy}  & str      & \texttt{"balanced"},
      \texttt{"greedy"} & Strategy for selecting wrap points \\
